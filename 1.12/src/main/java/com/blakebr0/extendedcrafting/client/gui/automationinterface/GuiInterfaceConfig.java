...
public class GuiInterfaceConfig extends GuiContainer {
	...
	public void initGui() {
		super.initGui();
		this.buttonList.add(new SmallButton(0, (this.width - this.xSize) / 2 + 61, (this.height - this.ySize) / 2 + 28, 70, 12, parent.tile.getInserterFaceName()));
		this.buttonList.add(new SmallButton(1, (this.width - this.xSize) / 2 + 61, (this.height - this.ySize) / 2 + 58, 70, 12, parent.tile.getExtractorFaceName()));
		this.buttonList.add(new SmallButton(10, (this.width - this.xSize) / 2 + 129, (this.height - this.ySize) / 2 + 85, 40, 12, "BACK"));
	}
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.fontRenderer.drawString(Utils.localize("ec.interface.auto_insert"), this.xSize / 2 - 20, 19, 4210752);
		this.fontRenderer.drawString(Utils.localize("ec.interface.auto_extract"), this.xSize / 2 - 23, 49, 4210752);
	}
