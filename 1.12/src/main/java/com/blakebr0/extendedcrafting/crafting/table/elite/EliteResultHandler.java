...
public class EliteResultHandler extends Slot {

	private final EliteCrafting crafting;
	private final EntityPlayer player;
	private final ItemStackHandler matrix;

	public EliteResultHandler(EntityPlayer player, InventoryCrafting craftingInventory, IInventory inventory, int slot,
			int x, int y) {
		super(inventory, slot, x, y);
		this.crafting = (EliteCrafting) craftingInventory;
		this.player = player;
		this.matrix = ((EliteCrafting) craftingInventory).tile.matrix;
	}
