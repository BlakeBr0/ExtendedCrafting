...
public class BlockBasicInterface extends BlockBase implements ITileEntityProvider, IEnableable {

	public BlockBasicInterface() {
		super("ec.interface_basic", Material.IRON, SoundType.METAL, 5.0F, 10.0F);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (!world.isRemote) {
			player.openGui(ExtendedCrafting.instance, GuiHandler.BASIC_INTERFACE, world, pos.getX(), pos.getY(), pos.getZ());
