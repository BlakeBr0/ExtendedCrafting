...
public class BlockUltimaterInterface extends BlockBase implements ITileEntityProvider, IEnableable {

	public BlockUltimaterInterface() {
		super("ec.interface_ultimater", Material.IRON, SoundType.METAL, 5.0F, 10.0F);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (!world.isRemote) {
			player.openGui(ExtendedCrafting.instance, GuiHandler.ULTIMATER_INTERFACE, world, pos.getX(), pos.getY(), pos.getZ());
