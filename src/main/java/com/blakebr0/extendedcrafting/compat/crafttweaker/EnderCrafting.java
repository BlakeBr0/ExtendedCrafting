...
@ZenRegister
public class EnderCrafting implements IRecipeManager {
	@ZenCodeType.Method
	public static void addShaped(String id, IItemStack output, IIngredient[][] ingredients) {
		addShaped(id, output, ingredients, ModConfigs.ENDER_CRAFTER_TIME_REQUIRED.get());
	}
