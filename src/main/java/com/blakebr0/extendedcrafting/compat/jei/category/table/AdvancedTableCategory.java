...
public class AdvancedTableCategory implements IRecipeCategory<RecipeHolder<ITableRecipe>> {
	private static final Identifier TEXTURE = ExtendedCrafting.resource("textures/jei/advanced_crafting.png");
	public static final IRecipeHolderType<ITableRecipe> RECIPE_TYPE = IRecipeHolderType.create(ExtendedCrafting.resource("advanced_crafting"));
	...
	public Component getTitle() {
		return Component.translatable("jei.category.extendedcrafting.advanced_crafting");
	}
	...
	public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<ITableRecipe> recipeHolder, IFocusGroup focuses) {
		...
		builder.addSlot(RecipeIngredientRole.OUTPUT, 129, 36).add(output);
