...
public class UltimateTableCategory implements IRecipeCategory<RecipeHolder<ITableRecipe>> {
	private static final Identifier TEXTURE = ExtendedCrafting.resource("textures/jei/ultimate_crafting.png");
	public static final IRecipeHolderType<ITableRecipe> RECIPE_TYPE = IRecipeHolderType.create(ExtendedCrafting.resource("ultimate_crafting"));
	...
	public Component getTitle() {
		return Component.translatable("jei.category.extendedcrafting.ultimate_crafting");
	}
	...
	public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<ITableRecipe> recipeHolder, IFocusGroup focuses) {
		...
		builder.addSlot(RecipeIngredientRole.OUTPUT, 85, 174).add(output);
