...
//
//	public TableShapedWrapper(IJeiHelpers helpers, ShapedTableRecipe recipe) {
//		this.helpers = helpers;
//		this.recipe = recipe;
//		this.required = helpers.getGuiHelper().createDrawable(JeiCompat.ICONS, 0, 0, 15, 15);
//	}
//
//	public TableShapedWrapper(IJeiHelpers helpers, ShapedTableRecipe recipe, int iconsX, int iconsY) {
//		this.helpers = helpers;
//		this.recipe = recipe;
//		this.required = helpers.getGuiHelper().createDrawable(JeiCompat.ICONS, 0, 0, 15, 15);
//		this.iconsX = iconsX;
