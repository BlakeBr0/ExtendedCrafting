...
//
//	public TableShapelessWrapper(IJeiHelpers helpers, ShapelessTableRecipe recipe) {
...
//	}
//
//	public TableShapelessWrapper(IJeiHelpers helpers, ShapelessTableRecipe recipe, int iconsX, int iconsY) {
//		this.helpers = helpers;
//		this.recipe = recipe;
//		this.required = helpers.getGuiHelper().createDrawable(JeiCompat.ICONS, 0, 0, 15, 15);
//		this.shapeless = helpers.getGuiHelper().createDrawable(JeiCompat.ICONS, 17, 0, 19, 15);
