...
public class NetworkHandler {
	...
	public static void onCommonSetup() {
		...
		INSTANCE.registerMessage(id(), SyncSingularitiesMessage.class, SyncSingularitiesMessage::write, SyncSingularitiesMessage::read, SyncSingularitiesMessage::onMessage);
	}
